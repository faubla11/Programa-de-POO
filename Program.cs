...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        IMostraraFactura miMouse = new mouse();
        Console.WriteLine(miMouse);

        ///Decoramos el mouse con un regalo si lo compran
        miMouse = new Cpendrive(miMouse);

        //Comprobamos la adicion de las caracteristicas
        Console.WriteLine(miMouse.regalo());
        Console.WriteLine(miMouse);
